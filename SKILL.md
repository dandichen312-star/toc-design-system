...
2. `skills/ui-page-generation/PAGE_RULES.md`
3. `skills/ui-page-generation/COMPONENT_RULES.md`
4. Only the relevant component docs in `skills/ui-page-generation/docs/components/`
